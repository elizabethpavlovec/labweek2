...
Because the fill is the question of aesthetics in sense of dividing the data by color and being a part of of the x and Y axes. On the other hand, alpha is the characteristics of all data and how the graph overall looks rather than programming the axes and the data. 
